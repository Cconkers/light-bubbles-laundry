...
export const site = {
  ...
  location: 'Sevilla',
  description:
    'Lavandería autoservicio en Sevilla: lava y seca a tu ritmo. Tarifas, horario y cómo llegar.',
  /**
  ...
  /** [PLACEHOLDER: rango de precios LocalBusiness — provisional para pruebas] */
  priceRange: '€',
};
